...
const PropertyAdd: NextPageWithLayout = () => {
  ...
  const handleHDBESTATEList = (newValue: any) => {
    ...
    trigger('hdb_estate')
    setHdb(newValue.target.textContent)
  }
                    ...
                    <div className="grid grid-cols-2 gap-7 mb-6  ">
                      ...
                      <FormControl variant="outlined" sx={customFormStyle?.sx_text_field}>
                        <Autocomplete
                          ...
                          sx={customFormStyle.sx_text_field}
                          {...register('district', { onChange: e => setDistrict(e.target.value) })}
                        />
                        <ErrorMessage
                          errors={errors}
                          name="district"
                        ...
                        {wholeUnit && wholeHdbList && (
                          ...
                          <FormControl variant="outlined" sx={customFormStyle?.sx_text_field}>
                            <Autocomplete
                              ...
                              {...register('hdb_estate', { onChange: handleHDBESTATEList })}
                  ...
                  <div>
                    ...
                    <div className="flex justify-between gap-3 md:gap-5 bg-[#EBF4FE] shadow-md rounded-b-[10px] px-6 py-3">
                      ...
                      <a href="https://mytax.iras.gov.sg/ESVWeb/default.aspx" target="_blank" rel="noreferrer">
                        <button
                          type="button"
                          className="bg-white text-sm  xl:text-base font-roboto font-normal text-[#00ADEE] capitalize  px-6 py-4 rounded-md">
                          <Image
                            alt="no-image"
