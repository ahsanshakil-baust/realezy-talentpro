...
const PropertyAdd: NextPageWithLayout = () => {
  ...
  console.log('🚀 ~ file: [[...propertyID]].tsx:169 ~ errors:', errors)
                        ...
                        {/* <Controller
                          ...
                          render={({ field: { onChange } }) => (
                            <DatePicker
                              ...
                              format="DD MMMM YYYY"
                              defaultValue={availableFrom && moment(availableFrom).format("DD MMMM YYYY")}
                              // minDate={dayjs(moment().format("DD MMMM YYYY"))}
                              minDate={todayDate && dayjs(todayDate)}
                              // {...register('available_from', {
                              //   onChange: (e: any) => handleAvailableDate(e?._d)
                              // })}
                              label="Available From*"
