...
const PersonalEdit = ({ setEditView, refetchUserProfileDetails }: any) => {
  ...
  const handlePersonalInfoUpdate = async (data: any) => {
    ...
    const payload = {
      ...
      date_of_birth: data.date_of_birth ? data.date_of_birth : userProfile?.date_of_birth,
      gender: data.gender,
      industry: '',
        ...
        <div className="flex items-center justify-between ">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-5 w-[300px] ml-5 justify-end">
              ...
              <button
                type="submit"
                className="flex items-center gap-2 text-white rounded-md px-8 py-3 cursor-pointer bg-userRole">
                Update
              </button>
            </div>
          </div>
                    ...
                    <div className="!w-[48%]">
                              ...
                              <div className='p-4'>
                                {
                                  Object.entries(salary).map(([item, amount]: any) => {
                                    ...
                                    return <p className='flex justify-between text-[#505050] text-sm'>
                                      <span>{(()=>{
                                        switch(item){
                      ...
                      <div className="flex justify-between">
                        ...
                        <button
                          style={{ width: '18%' }}
                          type="button"
                          className="h-14 px-2 bg-[#F1F7FF] border border-[#D1D1D1] rounded-lg cursor-pointer"
                          onClick={handleClickOpen}>
