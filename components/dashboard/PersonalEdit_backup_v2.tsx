...
import breakdown from 'public/breakdown.svg'
...
const PersonalEdit = ({ setEditView, refetchUserProfileDetails }: any) => {
    ...
    console.log("🚀 ~ file: PersonalEdit.tsx:145 ~ PersonalEdit ~ errors:", errors, watch('address'))
    ...
    const totalCount = () => {
        const total: any = Object.values(salary).reduce((acc: any, cur: any) => isNaN(parseInt(acc) + parseInt(cur)) ? parseInt(acc).toFixed(2) : parseInt(acc) + parseInt(cur), 0)
    ...
    const handlePersonalInfoUpdate = async (data: any) => {
        ...
        Object.entries(salary).forEach(([key, value]: any) => {
            if (parseInt(value) > 0) {
                salaryStr[key] = value.toString()
            }
        })

        const payload = {
            video_url: userProfile?.video_url,
            name: data.name,
            last_name: '',
    ...
    return (
        <>
            <form onSubmit={handleSubmit(handlePersonalInfoUpdate)} className="p-5 md:p-9">
                <div className="flex items-center justify-between ">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex gap-5 w-[300px] ml-5 justify-end">
                            ...
                            <button
                                type="submit"
                                className="flex items-center gap-2 rounded-md px-8 py-3 cursor-pointer bg-userRole text-white"
                            >
                                Update
                            </button>
                        </div>
                        ...
                        <div className="md:flex gap-3 md:gap-5 xl:gap-8 ">
                                                ...
                                                <Controller
                                                    ...
                                                    render={({ field: { onChange } }) => (
                                                        <DatePicker
                                                            ...
                                                            format="DD MMMM YYYY"
                                                            defaultValue={userProfile?.date_of_birth ? moment(userProfile?.date_of_birth) : moment().subtract(18, 'years')}
                          ...
                          <Button onClick={totalCount} autoFocus>
                            Save
                                                    ...
                                                    <Button onClick={handleClose} className='!bg-transparent'>
                                                        <div className='w-8 h-8 border-2 border-red-600 rounded-full flex items-center justify-center cursor-pointer' onClick={handleClose} >
                                                            <ClearOutlinedIcon style={{ color: '#E21B1B', fontSize: '25px' }} />
                                                        </div>
                                                    </Button>
                                                </DialogActions>
                                                <div className='flex bg-[#F1F7FF] px-7 py-5'>
                                                    <div className='flex-1 pr-4'>
                                                        <DialogContent sx={{ padding: 0 }}>
                                                            <DialogContentText className='pt-1' id="alert-dialog-description">
                                                                <TextField
                                                                    className='!w-full py-2'
                                                                    type="text"
                                                                    id="outlined-basic"
                                                                    ...
                                                                    InputProps={{
                                                                        endAdornment: (
                                                                            <IconButton
                                                                                disableRipple={true}
                                                                                aria-label="Clear"
                                                                                onClick={() => removeSalary('mainTenant_salary')}
                                                                                edge="end"
                                                                            >
                                                                                <ClearIcon className='!border !border-[#D1D1D1] rounded-md' />
                                                                            </IconButton>
                                                                        ),
                                                                    }}
                                                                    name="mainTenant_salary"
                                                                    ...
                                                                    InputProps={{
                                                                        endAdornment: (
                                                                            <IconButton
                                                                                disableRipple={true}
                                                                                aria-label="Clear"
                                                                                onClick={() => removeSalary('occupant1_salary')}
                                                                                edge="end"
                                                                            >
                                                                                <ClearIcon className='!border !border-[#D1D1D1] rounded-md' />
                                                                            </IconButton>
                                                                    ...
                                                                    InputProps={{
                                                                        endAdornment: (
                                                                            <IconButton
                                                                                disableRipple={true}
                                                                                aria-label="Clear"
                                                                                onClick={() => removeSalary('occupant2_salary')}
                                                                    ...
                                                                    InputProps={{
                                                                        endAdornment: (
                                                                            <IconButton
                                                                                disableRipple={true}
                                                                                aria-label="Clear"
                                                                                onClick={() => removeSalary('occupant3_salary')}
                                                                                edge="end"
                                                                            >
                                                                                <ClearIcon className='!border !border-[#D1D1D1] rounded-md' />
                                                                            </IconButton>
                                                                    ...
                                                                    InputProps={{
                                                                        endAdornment: (
                                                                            <IconButton
                                                                                disableRipple={true}
                                                                                aria-label="Clear"
                                                                                onClick={() => removeSalary('occupant4_salary')}
                                                                                edge="end"
                                                                            >
                                                                                <ClearIcon className='!border !border-[#D1D1D1] rounded-md' />
                                                                            </IconButton>
                                                                    ...
                                                                    InputProps={{
                                                                        endAdornment: (
                                                                            <IconButton
                                                                                ...
                                                                                aria-label="Clear"
                                                                                edge="end"
                                                                                onClick={() => removeSalary('occupant5_salary')}
                                                                            >
                                                                                <ClearIcon className='!border !border-[#D1D1D1] rounded-md' />
                                                                            </IconButton>
                                                                        ),
                                                    ...
                                                    <div className='w-[2px] h-auto bg-[#D4E8FF]'></div>

                                                    <div className='flex-1 pl-4 '>
                                                        <div className=' h-full bg-[#F8FBFF] rounded-br-lg rounded-bl-lg'>
                                                            <div className='flex justify-between bg-white p-4 shadow-sm rounded-tr-lg rounded-tl-lg'>
                                                                <p className='text-[#999999] font-normal'>Description</p>
                                                                <p className='text-[#999999] font-normal'>Amount</p>
                                                            </div>
                                                            <div className='p-4'>
                                                                {
                                                                    Object.entries(salary).map(([item, amount]: any) => {
                                                                        amount = parseFloat(amount)
                                                                        // console.log('item', item)
                                                                        // console.log('amount', amount)
                                                                        return <p key={item.toString()} className='flex justify-between text-[#505050] text-sm'>
                                                                            <span>{(() => {
                                                                                switch (item) {
                                                                                    case "mainTenant_salary":
                                                                                        return 'Main Tenant'
                                                                                    case "occupant1_salary":
                                                                                        return 'Occupant One'
                                                                                    case "occupant2_salary":
                                                                                        return 'Occupant Two'
                                                                                    case "occupant3_salary":
                                                                                        return 'Occupant Three'
                                                                                    case "occupant4_salary":
                                                                                        return 'Occupant Four'
                                                                                    case "occupant5_salary":
                                                                                        return 'Occupant Five'
                                                                                    default:
                                                                                        return ""
                                                                                }
                                                                            })()}</span>
                                                                            <span>${isNaN(amount) ? (0.00).toFixed(2) : parseFloat(amount).toFixed(2)}</span>
                                                                        </p>
                                                                    })
                                                                }
                                                            ...
                                                            <div className='p-4'>
                                                                <p className='w-full h-[2px] bg-[#D4E8FF]'></p>
                                                                <p className='flex justify-between'>
                                                                    <span className='text-[#00ADEE] text-sm pt-2'>TOTAL</span>
                                                                    <span className='text-[#00ADEE] text-sm pt-2'>${
                                                                        Object.values(salary).reduce((acc: any, cur: any) => isNaN(parseInt(acc) + parseInt(cur)) ? parseInt(acc).toFixed(2) : parseInt(acc) + parseInt(cur), 0)
                                                                    }</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className='flex gap-5 justify-start bg-[#F1F7FF] ml-7 mb-5'>
                                                    <button className='!bg-[#00ADEE] text-xl font-normal !w-28 !h-[50px] cursor-pointer !text-white rounded-xl' onClick={totalCount} autoFocus>
                                                        Save
                                                    </button>
                                                    <button onClick={handleClose} className='text-xl font-normal !w-28 !h-[50px] cursor-pointer !text-red-500 !border !border-red-500 rounded-xl'>
                                                        Cancel
                                                    </button>
                                                </div>
                                            </Dialog>
                                            <div className='flex justify-between'>
                                                ...
                                                <button style={{ width: '18%' }} type='button' className='h-14 px-2 bg-[#F1F7FF] border border-[#D1D1D1] rounded-lg cursor-pointer' onClick={handleClickOpen}>
                                                    <Image src={breakdown} width={50} height={30} />
                                                </button>
                                            </div>
                                        </div>
                                        <div className="!w-[48%]">
