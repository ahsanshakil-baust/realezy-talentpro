...
const AccordionFaqPage: React.FC<any> = ({ item }) => {
          ...
          <Accordion
            ...
            <AccordionDetails>
              {typeof item.content === 'string' ? (
                <Typography className="!text-[#034ea1] !text-left  !text-base !tracking-[0.16px] xl:!tracking-[0.32px] !leading-[30px]  !font-normal !font-roboto">
                  {item.content}
                </Typography>
              ) : (
                <Table>
...
export default AccordionFaqPage
