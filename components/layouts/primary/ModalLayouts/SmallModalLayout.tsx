...
const SmallModalLayout = ({modal}: any) => {
  ...
  return (
    <div
                  className="h-auto bg-[#f1f7ff] min-w-[736px] max-w-[1280px] max-h-[660px] 2xl:max-h-[840px] pb-4 shadow-[0px_-5px_20px_#00000040] outline-none focus:outline-none "
                  style={{
                      ...
                      {modal.headingRight ? (
                        ...
                        <div
                          ...
                          <img
                            src={
                              !hover
                                ? '/chat/chatProgressForm/FormCloseIcon.svg'
                                : '/chat/chatProgressForm/FormCloseIconHover.svg'
                            }
                            alt="close"
                            className="w-10 h-10"
                          />
