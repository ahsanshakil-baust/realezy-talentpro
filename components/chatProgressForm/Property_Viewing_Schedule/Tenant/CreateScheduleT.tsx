      ...
      <form onSubmit={handleSubmit(scheduleHandler)}>
        <div className="flex gap-5">
          <div className="w-2/5 border border-blue-300 rounded-md shadow-md">
            <input className="" type="radio" id="house_viewing" {...register('purpose')} value="house_viewing" />
            <label className="py-3 inline-block" htmlFor="house_viewing">
              House Viewing
            </label>
          </div>
          <div className="w-2/5 border border-blue-300 rounded-md shadow-md">
            <input disabled type="radio" id="key_handover" {...register('purpose')} value="key_handover" />
        ...
        <button type="submit" className="bg-primary px-5 py-3 text-white cursor-pointer">
          Add Schedule
        </button>
      </form>
    </div>
...
export default CreateScheduleT
