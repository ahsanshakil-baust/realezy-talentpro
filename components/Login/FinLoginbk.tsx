  ...
  return (
    <div>
      ...
      <Modal
        ...
        <div className=" !w-[340px] sm:!w-[400px]  md:!w-[500px]  lg:!w-[530px] xl:!w-[550px] 2xl:!w-[620px] !mt-44 !outline-none focus:!outline-none   ">
          {!loading && (
            <div className=" w-full  flex flex-col  rounded-[20px] bg-[#F8FBFF]  ">
              <div className="relative 2xl:mt-10 md:mt-8 mt-6 ">
                <span
              ...
              <div className="z-10 w-[100%] flex flex-col items-center  px-8 md:px-[45px] lg:px-[55px] xl:px-[65px] 2xl:px-[75px] pb-1 md:pb-[7.5px] lg:pb-[9.5px] xl:pb-[10.5px] 2xl:pb-[14px] ">
                <form onSubmit={handleSubmit(handleLogin)}>
                  ...
                  <h2 className="mt-1 text-center capitalize font-roboto font-medium text-lg xl:text-2xl text-[#00ADEE] md:text-sm ">
                    Welcome To RealEzy
                  </h2>
